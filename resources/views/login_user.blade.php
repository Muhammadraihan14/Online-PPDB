...
@section ('title', 'Login User | Portal SMANSAKA')
...
<div class="container">
       <!--  <div class="box-image">
        ...
        <img src={{asset ('image/login_user.svg')}} class="img-fluid" alt="image">
        <form action="" method="">
        ...
        <a href="/reg" class="btn btn-outline-primary mt-2">
        ...
        <hr>
        <div class="d-grid gap-2">
        <a href="/tambah_akun" target="_blank" class="btn btn-outline-success mt-2">
